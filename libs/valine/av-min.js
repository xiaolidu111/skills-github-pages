	...
	return (function (t) {
			...
			var r = n(3),
				...
				y = function (t, e, n, r, i, o, s) {
					...
					if (
						...
						throw new Error(
							'_fetchWhenSave should be in the query'
						);
					if (i && i._where)
		...
		function (t, e, n) {
			...
			var i = n(3),
				...
				m = function (t) {
					return (
						u.isObject(t) && (0, a.default)(t) === Object.prototype
					);
				},
				g = function t(e, n) {
					return e()
				...
				(g._sharedConfig = { userAgent: O, liveQueryRealtime: null }),
					...
					(g._traverse = function (t, e, n) {
						if (t instanceof g.Object) {
							...
							return (
								n.push(t), g._traverse(t.attributes, e, n), e(t)
							);
						}
			...
			var r = n(9),
				...
				s = Object(r.a)(function (t, e) {
					var n = s.placeholder,
						r = function () {
							for (
								var o = 0, s = e.length, a = Array(s), u = 0;
								u < s;
								u++
							)
		...
		function (t, e, n) {
			...
			function r(t) {
				return (
					null != t && Object(o.a)(t.getInt8) && Object(s.a)(t.buffer)
				);
			}
			var i = n(5),
				o = n(13),
			...
			function r(t, e, n) {
				return function (r, a, u) {
					...
					if ('number' == typeof u)
						...
						return (u = n(r, a)), r[u] === a ? u : -1;
					if (a !== a)
						return (
							(u = e(o.q.call(r, c, f), s.a)), u >= 0 ? u + c : -1
						);
		...
		function (t, e, n) {
			...
			function i(t, e, n, o) {
				...
				if ((n.push(t), o.push(e), y)) {
					...
					var w,
						j = Object(h.a)(t);
					if (((O = j.length), Object(h.a)(e).length !== O))
						return !1;
					for (; O--; )
						if (
							((w = j[O]),
		...
		function (t, e, n) {
			...
			function r(t, e, n) {
				e = Object(i.a)(e, n);
				for (
					var r = Object(o.a)(t), s = r.length, a = {}, u = 0;
					u < s;
					u++
				) {
					var c = r[u];
		...
		function (t, e, n) {
			...
			function i(t, e, n) {
				!e && n && (e = n),
					(e = Object(o.a)({}, e, s.a.templateSettings));
				var i = RegExp(
						[
							(e.escape || a).source,
		...
		function (t, e, n) {
			...
			function r(t, e) {
				var n = function (r) {
					...
					return (
						Object(i.a)(o, s) || (o[s] = t.apply(this, arguments)),
						o[s]
					);
				};
				return (n.cache = {}), n;
				...
				if (
					...
					s._setServerURLs(
						l(
							{},
							r(e),
							s._config.serverURLs,
							'string' == typeof y ? v(y) : y
						),
						w
					),
					O)
				...
				(r.prototype.refresh = function () {
					...
					if (!(this.disabled || Date.now() < this.lockedUntil)) {
						...
						return i({
							...
							.catch(function (e) {
								console.warn(
									'refresh server URLs failed: ' + e.message
								),
									t.lock(600);
							});
					}
		...
		function (t, e, n) {
			...
			Q ||
				((k = function () {
					...
					return (
						o && z && K(B, t, { configurable: !0, set: e }), J(t)
					);
				}),
				...
				(t.Events = {
					...
					off: function (t, n, i) {
						...
						if ((s = this._callbacks)) {
							...
							for (
								t = t ? t.split(e) : r.keys(s), o = t.shift();
								o;
							...
							if (e) {
								...
								if (e instanceof t.Op.Remove)
									return new t.Op.Remove(
										r.union(e.objects(), this.objects())
									);
								throw new Error(
									'Op is invalid after previous op.'
								);
			...
			var a = n(160),
				...
				N = (function (t) {
					function e(t, n, r, i) {
						...
						var o = (0, f.default)(
							this,
							(e.__proto__ || (0, u.default)(e)).call(
								this,
								t,
								n,
								r,
					...
					('__proto__' in {}
						? (function (t, e, r) {
								try {
									(r = n(31)(
										Function.call,
										n(94).f(Object.prototype, '__proto__')
											.set,
										2
									)),
										r(t, []),
				...
				(t.Object = function (e, n) {
					...
					(t.Object.destroyAll = function (t) {
						...
						var n = h.groupBy(t, function (t) {
								return (0,
								u.default)({ className: t.className, flags: t._flags });
							}),
							r = {
						...
						return _('batch', null, null, 'POST', r, e).then(
							function (t) {
								var e = h.find(t, function (t) {
									return !t.success;
								});
					...
					'_User',
					{
						...
						associateWithQQAppWithUnionId: function (e) {
							var n = this,
								...
								s = r.asMainAccount,
								a = void 0 !== s && s;
							return b('getAuthInfo')({ platform: o }).then(
								function (r) {
									return (
						...
						getRoles: function (e) {
							return t.Relation.reverseQuery(
								'_Role',
								'users',
								this
							).find(e);
				...
				(t.Query = function (e) {
					...
					(t.Query.doCloudQuery = function (e, n, r) {
						...
						return (
							...
							d('cloudQuery', null, null, 'GET', i, r).then(
								function (e) {
					...
					u.extend(t.Query.prototype, {
						...
						_createRequest: function () {
							...
							if (
								encodeURIComponent((0, o.default)(t)).length >
								2e3
							) {
								return h({
									path: '/batch',
						...
						constructor: function (t, e, n, r) {
							...
							s.apply(this),
								...
								(this._onReconnect = function () {
									l(i._queryJSON, i._subscriptionId).catch(
										function (t) {
											return console.error(
												'LiveQuery resubscribe error: ' +
													t.message
											);
										}
									);
					...
					(t.Captcha.prototype.bind = function (t, e) {
						...
						(this.__refresh = function () {
							return n
								...
								.catch(function (t) {
									return console.warn(
										'refresh captcha fail: ' + t.message
									);
								});
						}),
							i &&
				...
				(t.Cloud = t.Cloud || {}),
					o.extend(t.Cloud, {
						...
						getServerDate: function () {
							return a('date', null, null, 'GET').then(function (
								e
							) {
								return t._decode(e);
							});
			...
			t.exports = function (t) {
				...
				(t.Status = function (t, e) {
					...
					(t.Status.sendStatusToFollowers = function (e) {
						...
						return n(r).then(function (n) {
							...
							return (
								...
								c('statuses', null, null, 'POST', o, r).then(
									function (n) {
										return (
											(e.id = n.objectId),
											(e.createdAt = t._parseDate(
					...
					(t.Status.sendPrivateStatus = function (e, r) {
						...
						return n(i).then(function (n) {
							...
							return (
								...
								(s.inboxType = 'private'),
								(e.inboxType = 'private'),
								c('statuses', null, null, 'POST', s, i).then(
									function (n) {
										return (
											(e.id = n.objectId),
											(e.createdAt = t._parseDate(
					...
					(t.InboxQuery = t.Query._extend({
						...
						_getParams: function () {
							var e =
								t.InboxQuery.__super__._getParams.call(this);
							return (
				...
				t.Friendship = {
					request: function (e, n) {
						...
						var i = void 0,
							s = void 0;
						e.friend
							? ((i = e.friend), (s = e.attributes))
							: (i = e);
						var a = r.isString(i)
							? t.Object.createWithoutData('_User', i)
							: i;
						return o({
							method: 'POST',
				...
				(e.upload = function (t, e, n) {
					...
					if (null === l || void 0 === l ? void 0 : l.aborted)
						return Promise.reject(
							new i.AbortError('Request aborted')
						);
					...
					return (
						...
						new Promise(function (t, e) {
							var n = function () {
								e(new i.AbortError('Request aborted')),
									d.abort();
							};
							null === l ||
								void 0 === l ||
								l.addEventListener('abort', n),
								d
									.then(function (e) {
										return t(r(e));
									})
				...
				for (
					...
					(e = i[o]),
						...
						-1 === n
							...
							: (r[decodeURIComponent(e.slice(0, n))] =
			...
			(C.serializeObject = s),
				...
				(l.prototype.toError = function () {
					var t = this.req,
						...
						i = new Error(r);
					return (
						(i.status = this.status), (i.method = e), (i.url = n), i
					);
				}),
				(C.Response = l),
				O(d.prototype),
				...
				(o.prototype.then = function (t, e) {
					...
					if (!this._fullfilledPromise) {
						...
						this._endCalled &&
							...
							(this._fullfilledPromise = new u.default(function (
								t,
								e
							) {
								r.on('abort', function () {
